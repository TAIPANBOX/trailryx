...
- GET /healthz on trailryx-ingest's listener, unauthenticated: 200 while the source is healthy, 503 once is_degraded() is true, and not subject to the connection, pending-queue or in-flight body budgets the OTLP routes enforce
