...
![Tests](https://img.shields.io/badge/tests-1172-success.svg)
...
| `trailryx-agentevent` | the estate's shared agent-event envelope, mapped into records: the same `agent://` grammar, the same run and delegation chain | 21 |
